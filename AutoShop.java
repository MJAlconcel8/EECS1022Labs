...
public class AutoShop {
     ...
     */
    private final HashSet<Vehicle> vehicles = new HashSet<>();
    ...
    public AutoShop(AutoShop other) {
        ...
        this.vehicles.addAll(other.vehicles);
    }
    ...
    public void changeOwner(ShopOwner currentOwner, ShopOwner newOwner) {
        ...
        // TODO: COMPLETE THIS
       if (Objects.equals(this.owner , currentOwner)){
           this.owner = newOwner;
       }
       else{
           throw new IllegalArgumentException("Unable to change owner");
       }
    }
    ...
    public void add(List<Vehicle> vehicles) {
        ...
        // TODO: COMPLETE THIS
        for (Vehicle a: this.vehicles){
            for (Vehicle b: this.vehicles){
                if(a==b){
                    throw new IllegalArgumentException("addVehicles did not correctly add vehicles");
                }
            }
        }
    ...
    public List<Vehicle> deepCopy() {
        List<Vehicle> returnedlist = new ArrayList<>(this.vehicles.size());
        for (Vehicle a: this.vehicles){
            returnedlist.add(new Vehicle(a.getMake(),a.getYearMake(), a.getNumOfDoors(), a.getPrice()));
        }
    ...
    public List<Vehicle> shallowCopy() {
        List<Vehicle> x = new ArrayList<>(this.vehicles);
        Collections.sort(x);
        return x;
